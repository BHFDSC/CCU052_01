...
use  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\age_sex_asthma_rates_all_imd_ethnic", clear 
...
save  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\crude_asthma_rates_by_imd", replace 

export delimited month_year  overall_numerator overall_denom IMD_2019_DECILES rate_est rate_se rate_lb rate_ub  using  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\crude_asthma_rates_by_imd.csv" , datafmt replace 
...
save  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\crude_asthma_rates_by_ethnic", replace 

export delimited month_year  overall_numerator overall_denom ethnicity rate_est rate_se rate_lb rate_ub  using  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\crude_asthma_rates_by_ethnic.csv" , datafmt replace 
...
save  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\adj_asthma_rates_by_imd", replace 

export delimited month_year IMD_2019_DECILES rate_est rate_lb rate_ub using  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\adj_asthma_rates_by_imd.csv" , datafmt replace 
...
save  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\adj_asthma_rates_by_ethnic", replace 

export delimited month_year ethnicity rate_est rate_lb rate_ub using  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\adj_asthma_rates_by_ethnic.csv" , datafmt replace 


************************************
*IMD strat by children and adults 
**************************************	
use  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\age_sex_asthma_rates_all_imd_ethnic", clear 
*keep children 
keep if age_group<5
...
keep month_year SEX IMD_2019_DECILES age_group overall_numerator overall_denom
duplicates drop
...
export delimited month_year IMD_2019_DECILES rate_est rate_lb rate_ub using  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\adj_asthma_rates_by_imd_children.csv" , datafmt replace 
...
export delimited month_year IMD_2019_DECILES rate_est rate_lb rate_ub using  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\Final_rates\adj_asthma_rates_by_imd_adults.csv" , datafmt replace 
