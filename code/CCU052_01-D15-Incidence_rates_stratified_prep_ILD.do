*ILD INCIDENCE RATES- STRATIFIED by age, gender, region
...
keep month_year SEX region age_group tot_ild_`i'  
save "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_numerator_chunk`i'", replace 
}

*Merge all together and sum counts from each count for each month
use "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_numerator_chunk1", clear 
forvalues i=2/10{
	merge 1:1 month_year SEX region age_group using "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_numerator_chunk`i'"
	drop _m
}
...
save  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_numerator_all", replace 
...
duplicates drop 
save "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_chunk_`x'_age_sex_denom_month`i'", replace 
restore 
}

use "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_chunk_`x'_age_sex_denom_month0", clear 
forvalues i=1/43{
append using "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_chunk_`x'_age_sex_denom_month`i'"
}
save "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_denom_all_chunk_`x'", replace 
}
 
forvalue i=1/10{
	use  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_denom_all_chunk_`i'", clear
	rename tot_person_time tot_person_time`i'
save "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_denom_all_chunk_`i'", replace 
}

*************************************************
*Format numerator and denomintor to calculate rates
*************************************************
use "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_denom_all_chunk_1", clear 
forvalues i=2/10{ 
	merge 1:1 month_year SEX region age_group using "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_denom_all_chunk_`i'"
	drop _m
}
...
save  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_denom_all", replace 

use  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_numerator_all", clear 
merge 1:1 month_year SEX region age_group using "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\ild_age_sex_denom_all"
drop _m
recode numerator .=0
save  "D:\PhotonUser\My Files\Home Folder\StataFiles\CCU052\age_sex_ild_rates_all", replace 
